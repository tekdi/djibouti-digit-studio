...
const features = [
  {
    ...
    description:
      "Accédez facilement à tous vos services administratifs en ligne",
  ...
  },
  {
    ...
    description:
      "Une expérience utilisateur moderne et intuitive pour tous",
  ...
  },
  {
    ...
    description:
      "Suivez vos demandes en temps réel et obtenez des réponses rapides",
    color: "text-djibouti-primary",
  },
];
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-white p-12">
          <div className="backdrop-blur-sm bg-white/10 p-12 rounded-3xl shadow-2xl max-w-xl border border-white/20">
            <div className="flex items-center gap-3 mb-12">
              ...
              <h1 className="text-4xl font-bold">Espace Citoyen</h1>
            </div>
