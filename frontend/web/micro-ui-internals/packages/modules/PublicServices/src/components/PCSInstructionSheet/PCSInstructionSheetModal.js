...
const PCSInstructionSheetModal = ({
  isOpen,
  onClose,
  applicationNumber,
  service,
  ...
  const { isLoading, submitFiche, uploadFile, getFileUrl, downloadFile } =
    usePCSInstructionSheetAPI(tenantId, serviceCode, applicationNumber);
  ...
  const validate = () => {
    ...
    if (!formData.projectType || !String(formData.projectType).trim()) e.projectType = "Champ requis";
    ...
    <div className="fixed inset-0 bg-gray-50 z-[1000] flex flex-col" onClick={onClose}>
      ...
      <div className="bg-white w-full h-full overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-between px-6 lg:px-8 py-4 border-b border-gray-200 bg-white">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Fiche d'instruction — Détails du projet simplifié</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="md:col-span-2">
              {field("pcoNumber", "Numéro du Permis de Construire", {
                placeholder: "Ex: P7-PCS-N°184/2026",
                hint: "P7-PCS-N°184/2026",
              })}
            </div>
            ...
            {field("projectType", "Type de Projet", {
              required: true,
              placeholder: "Ex: Construction résidentielle simplifiée",
            })}
            ...
            {field("builtArea", "Surface bâtie (m²)", { placeholder: "Ex: 150" })}
            <div>
...
PCSInstructionSheetModal.propTypes = {
...
export default PCSInstructionSheetModal;
