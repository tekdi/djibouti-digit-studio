const configModal = (t, action, approvers, businessService, moduleCode, documentConfig = []) => {
  ...
  const assignableRoles =
    action.actions?.filter((actionItem) => actionItem.action !== "ADD_QUERY")?.flatMap((actionItem) => actionItem.roles || []) || [];
          ...
          },
          {
            ...
            populators: {
              ...
              hideInForm:
                ...
                actionString === "SEND_BACK_TO_SOURCE",
              optionsCustomStyle: {
                top: "2.3rem",
              },
            },
