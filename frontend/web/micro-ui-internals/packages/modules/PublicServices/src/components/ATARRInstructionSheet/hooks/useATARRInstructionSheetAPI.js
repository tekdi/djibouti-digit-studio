...
export const useATARRInstructionSheetAPI = (tenantId, serviceCode, applicationNumber) => {
  ...
  const submitFiche = useCallback(
    async (formData, service, state, isEdit = false, existingData = null) => {
      ...
      try {
          ...
          body: {
            ...
            Application: {
              ...
              additionalDetails: {
                ...
                atarrInstructionSheet: ficheData,
              },
            },
          },
        };
        ...
        return updated?.additionalDetails?.atarrInstructionSheet || ficheData;
      } finally {
        setIsLoading(false);
      }
    },
  ...
  const getFiche = useCallback(async () => {
    try {
      ...
      return app?.additionalDetails?.atarrInstructionSheet || null;
    } catch (e) {
      console.error("Error loading ATARR fiche:", e);
      return null;
    }
  }, [tenantId, serviceCode, applicationNumber]);
