    ...
    <div className="space-y-6 mb-8 mt-8">
      ...
      <div>
        <label className="block mb-3 font-semibold text-base text-gray-800">
          Observations / Commentaires <span className="text-gray-500 font-normal">(Optionnel)</span>
        </label>
        {isViewMode && !isEditMode ? (
          ...
          <textarea
            ...
            placeholder="Entrez vos observations sur les plans d'exécution..."
            ...
            {formData.finalOpinion && (
              <span
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl font-semibold ${
                  formData.finalOpinion === "APPROVED"
