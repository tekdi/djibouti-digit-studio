...
export const usePFInstructionSheetAPI = (tenantId, serviceCode, applicationNumber) => {
          ...
          body: {
            ...
            Application: {
              ...
              additionalDetails: {
                ...
                pfInstructionSheet: ficheData,
              },
            },
          },
        });
        const updated = Array.isArray(resp?.Application) ? resp.Application[0] : resp?.Application;
        return updated?.additionalDetails?.pfInstructionSheet || ficheData;
      } finally {
        setIsLoading(false);
      }
    },
  ...
  const getFiche = useCallback(async () => {
    try {
      ...
      return app?.additionalDetails?.pfInstructionSheet || null;
    } catch (e) { return null; }
  }, [tenantId, serviceCode, applicationNumber]);
