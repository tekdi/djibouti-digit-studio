...
const SuccessModal = ({ message, onClose, autoClose = true, duration = 3000 }) => {
  useEffect(() => {
    if (autoClose) {
        ...
        <div className="p-8">
          <div className="flex items-center justify-center mb-4">
            <div className="relative">
              <div className="absolute inset-0 bg-[#22a4d9]/20 rounded-full animate-ping" />
              <div className="relative bg-[#22a4d9] rounded-full p-3">
                <LuCircleCheckBig className="w-8 h-8 text-white" />
              </div>
            </div>
          </div>
          <h3 className="text-xl font-bold text-gray-900 text-center mb-2">Succès</h3>
