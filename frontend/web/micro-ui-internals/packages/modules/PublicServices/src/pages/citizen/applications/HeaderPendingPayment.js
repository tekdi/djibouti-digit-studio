...
import { LuSearch, LuRefreshCw, LuCreditCard, LuCircleAlert, LuCalendar } from "react-icons/lu";
...
const HeaderPendingPayment = ({ 
  ...
  return (
    <Fragment>
      {/* Header */}
      <div className="mb-8">
        <div className="bg-gradient-to-r from-orange-100 to-orange-200 rounded-3xl p-8 border border-orange-100">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-3 px-6 py-3 bg-white border border-orange-200 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md ${
                isRefreshing 
                  ? 'opacity-50 cursor-not-allowed' 
                  : 'hover:bg-orange-50 hover:border-orange-300'
              }`}
            >
              <LuRefreshCw className={`w-5 h-5 text-orange-600 ${isRefreshing ? 'animate-spin' : ''}`} />
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-6 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 text-lg"
                />
              </div>
            </div>
            ...
            <div className="lg:w-64">
              <select
                ...
                className="w-full px-6 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 text-lg"
              >
