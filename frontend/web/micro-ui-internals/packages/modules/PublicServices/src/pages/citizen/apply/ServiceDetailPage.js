...
const ServiceDetailPage = () => {
  ...
  const handleStartRequest = () => {
    // Navigate to the actual application form with correct URL structure
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-djibouti-primary mx-auto"></div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Le service demandé n'existe pas dans notre base de données.</p>
          <p className="text-gray-500 mb-4">Service ID: {serviceId}</p>
          <button
            onClick={handleBackToServices}
            className="px-4 py-2 bg-djibouti-primary text-white rounded-lg hover:bg-djibouti-primary-dark transition-colors"
          >
            Retour aux services
          </button>
        </div>
