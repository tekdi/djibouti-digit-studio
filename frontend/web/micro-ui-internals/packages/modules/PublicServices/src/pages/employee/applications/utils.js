...
export const getStatusInfo = (status) => {
  ...
  const statusConfig = {
    ...
    SDECC_AGENT_NOT_ASSSIGNED: {
      label: "Agent SCC Privée non assigné",
      color: "text-red-600",
      bgColor: "bg-red-50",
      icon: LuCircleAlert,
      progress: 10,
    ...
    PENDING_ACTION_BY_SDECC_AGENT: {
      label: "Action requise par l'agent SCC Privée",
      color: "text-amber-600",
      bgColor: "bg-amber-50",
      icon: LuClock,
      progress: 45,
    ...
    SDECC_AGENT_REPORT_READY: {
      label: "Rapport de l'agent SCC Privée prêt",
      color: "text-green-600",
      bgColor: "bg-green-50",
      icon: LuCircleCheck,
      progress: 60,
    ...
    SUBMITTED_TO_SDECC: {
      label: "Transmis au Chef de SCC Privée",
      color: "text-blue-600",
      bgColor: "bg-blue-50",
      icon: LuClock,
      progress: 50,
    ...
    SUBMITTED_TO_SDECC_HOD: {
      label: "Soumis au Chef de SCC Privée",
      color: "text-blue-600",
      bgColor: "bg-blue-50",
      icon: LuClock,
      progress: 50,
    ...
    SDECC_HOD_REVIEW: {
      label: "Révision par le Chef de SCC Privée",
      color: "text-amber-600",
      bgColor: "bg-amber-50",
      icon: LuClock,
      progress: 70,
