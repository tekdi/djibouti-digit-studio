...
const MultiUploadWrapper = ({
  ...
  showHintBelow,
  hintText,
  allowedFileTypesRegex = /(.*?)(jpg|jpeg|webp|aif|png|image|pdf|msword|openxmlformats-officedocument|doc|docx)$/i,
  allowedMaxSizeInMB = 10,
  acceptFiles = "image/*, .jpg, .jpeg, .webp, .aif, .png, .image, .pdf, .msword, .openxmlformats-officedocument, .dxf, .doc, .docx",
  maxFilesAllowed,
  customClass = "",
  customErrorMsg,
  containerStyles,
